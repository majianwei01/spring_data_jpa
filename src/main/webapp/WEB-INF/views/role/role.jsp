...
<table id="roleGrid" class="easyui-datagrid"
    ...
    <tr>
        ...
        <%--，formatter:arrFormat 调用role.js里的arrFormat，遍历循环--%>
        <th data-options="field:'permissions',width:100,formatter:arrFormat">权限</th>
...
--%>
<div id="roleDlg" class="easyui-dialog" title="操作功能"
     data-options="closed:true,modal:true,buttons:'#roleDlgBtns'" style="width:340px;padding:10px">
    <%--员工对应的Form表单--%>
...
<div id="roleDlgBtns">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton c3" onclick="$('#roleDlg').dialog('close')">取消</a>
</div>
