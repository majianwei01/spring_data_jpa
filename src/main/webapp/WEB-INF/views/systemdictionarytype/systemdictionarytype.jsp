...
<%--展示systemdictionarytype的grid--%>
<table id="systemdictionarytypeGrid" class="easyui-datagrid"
       data-options="url:'/systemdictionarytype/page2',
       fit:true,
       fitColumns:true,
       singleSelect:true,
       pagination:true,
...
--%>
<div id="systemdictionarytypeDlg" class="easyui-dialog" title="操作功能"
     data-options="closed:true,modal:true,buttons:'#systemdictionarytypeDlgBtns'" style="width:340px;padding:10px">
    <%--员工对应的Form表单--%>
...
<%--弹出框对应的按键组--%>
<div id="systemdictionarytypeDlgBtns">
    <a href="javascript:void(0)" data-method="save" class="easyui-linkbutton c1">确认</a>
    <a href="javascript:void(0)" class="easyui-linkbutton c3" onclick="$('#systemdictionarytypeDlg').dialog('close')">取消</a>
</div>
