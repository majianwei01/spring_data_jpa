...
<table id="producttypeGrid" class="easyui-datagrid"
       data-options="url:'/producttype/page2',
       fit:true,
       fitColumns:true,
       singleSelect:true,
       pagination:true,
...
--%>
<div id="producttypeDlg" class="easyui-dialog" title="操作功能"
     data-options="closed:true,modal:true,buttons:'#producttypeDlgBtns'" style="width:340px;padding:10px">
    <%--员工对应的Form表单--%>
...
<%--弹出框对应的按键组--%>
<div id="producttypeDlgBtns">
    <a href="javascript:void(0)" data-method="save" class="easyui-linkbutton c1">确认</a>
    <a href="javascript:void(0)" class="easyui-linkbutton c3" onclick="$('#producttypeDlg').dialog('close')">取消</a>
</div>
