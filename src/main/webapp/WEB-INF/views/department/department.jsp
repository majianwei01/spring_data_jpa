...
<table id="departmentGrid" class="easyui-datagrid"
       data-options="url:'/department/page2',
       fit:true,
       fitColumns:true,
       singleSelect:true,
       pagination:true,
...
--%>
<div id="departmentDlg" class="easyui-dialog" title="操作功能"
     data-options="closed:true,modal:true,buttons:'#departmentDlgBtns'" style="width:340px;padding:10px">
    <%--员工对应的Form表单--%>
...
<%--弹出框对应的按键组--%>
<div id="departmentDlgBtns">
    <a href="javascript:void(0)" data-method="save" class="easyui-linkbutton c1">确认</a>
    <a href="javascript:void(0)" class="easyui-linkbutton c3" onclick="$('#departmentDlg').dialog('close')">取消</a>
</div>
