...
--%>
<div id="deptDlg" class="easyui-dialog" title="操作功能"
     data-options="closed:true,modal:true,buttons:'#deptDlgBtns'" style="width:340px;padding:10px">
    <%--员工对应的Form表单--%>
...
<div id="deptDlgBtns">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton c3" onclick="$('#deptDlg').dialog('close')">取消</a>
</div>
