$(function () {
    ...
    var producttypeDlg=$("#producttypeDlg");
    ...
    itsource = {
        add(){
            ...
            //显示咱们的表单窗口
            producttypeDlg.dialog("center").dialog("open");
        },
        ...
        save(){
            ...
            if(id){
                url = "/producttype/update?_cmd=update";
                console.debug("56789");
            }
            ...
            producttypeForm.form('submit', {
                ...
                onSubmit: function(){
                    // 一般在这里面做验证功能
                    return producttypeForm.form("validate");
                },
