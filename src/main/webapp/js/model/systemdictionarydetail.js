$(function () {
    ...
    itsource = {
        add(){
            ...
            //显示咱们的表单窗口
            systemdictionarydetailDlg.dialog("center").dialog("open");
        },
        ...
        save(){
            ...
            if(id){
                url = "/systemdictionarydetail/update?_cmd=update";
                console.debug("56789");
            }
            ...
            systemdictionarydetailForm.form('submit', {
                ...
                onSubmit: function(){
                    // 一般在这里面做验证功能
                    return systemdictionarydetailForm.form("validate");
                },
                ...
                $.messager.confirm('提示','确认删除这行数据吗？',function(r){
                    if (r){
                        ...
                        $.get("/systemdictionarydetail/delete",{id:row.id},function(result){
                            ...
                            if(result.success){
                                //6.删除成功的话,页面进行刷新
                                systemdictionarydetailGrid.datagrid("load");
                            }else{
                                $.messager.alert('提示','删除失败! 原因:'+result.msg,'error');
                            }
                        })
