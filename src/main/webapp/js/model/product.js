//v:当前这一个值  r:当前这一行的值 i:第几行
//默认使用js 5的方案进行的判断
//显示值
function formatObj(v,r,i) {
    return v?v.name:"没有值";
}
...
function formatImg(v) {
    if (v){
        return `<img style="height: 30px;width: 40px;" alt="无图" src="${v}" />`;
    }
}
...
$(function () {
    ...
    itsource = {
        add(){
            ...
            //显示咱们的表单窗口
            productDlg.dialog("center").dialog("open");
        },
