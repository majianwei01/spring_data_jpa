$(function () {
    ...
    //拿到页面中常用的一些组件
    //拿到有用户信息的组件
    var depotGrid = $("#depotGrid");
    var searchForm = $("#searchForm");
    var depotDlg=$("#depotDlg");
    var depotForm=$("#depotForm");
    ...
    itsource = {
        add(){
            ...
            //显示咱们的表单窗口
            depotDlg.dialog("center").dialog("open");
        },
        ...
        save(){
            ...
            depotForm.form('submit', {
                ...
                onSubmit: function(){
                    // 一般在这里面做验证功能
                    return depotForm.form("validate");
                },
        ...
        delete(){
            //1.获取选中的是哪一行数据
            var row = depotGrid.datagrid("getSelected");
            if(row){
                //3.用户选择是否要进行删除
        ...
        search(){
            ...
            //根据查询的值刷新grid数据
            depotGrid.datagrid("load",params);
        }
    };
